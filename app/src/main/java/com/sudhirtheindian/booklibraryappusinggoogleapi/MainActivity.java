package com.sudhirtheindian.booklibraryappusinggoogleapi;
...
//        String url = "https://api.tvmaze.com/search/shows?q=all" + query;
//        String url = "https://api.tvmaze.com/search/shows?q=${search_term}" + query;
        String url = "https://www.api.tvmaze.com/search/shows?q=$" + query;
